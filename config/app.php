...
//        Illuminate\Translation\TranslationServiceProvider::class, //replaced on next line
  ...
  */
    ...
    'api_key_insw' => env('APP_API_KEY_INSW'),
    'endpoint_saldoawal' => env('APP_ENDPOINT_SALDOAWAL'),
    'endpoint_pemasukan' => env('APP_ENDPOINT_PEMASUKAN'),
    'kode_pemasukan' => env('APP_KODE_PEMASUKAN'),
    'endpoint_pengeluaran' => env('APP_ENDPOINT_PENGELUARAN'),
    'kode_pengeluaran' => env('APP_KODE_PENGELUARAN'),
