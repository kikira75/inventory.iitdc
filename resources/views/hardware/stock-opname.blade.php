      ...
      <form class="form-horizontal" method="post" action="" autocomplete="off" enctype="multipart/form-data">
          ...
          <div class="form-group {{ $errors->has('jumlah_barang_sebelumnya') ? ' has-error' : '' }}">
            ...
            <div class="col-md-7 col-sm-12">
              <input class="form-control" type="text" name="jumlah_barang" aria-label="jumlah_barang" id="jumlah_barang"
                value="{{ old('jumlah_barang', $item->jumlah_barang) }}" {!! (Helper::checkIfRequired($item, 'jumlah_barang_sebelumnya' ))
                ? ' data-validation="required" required' : '' !!} readonly />
          ...
          <div class="form-group {{ $errors->has('nomor_dokumen_kegiatan') ? ' has-error' : '' }}">
            ...
            <div class="col-md-7 col-sm-12">
                <input class="form-control" type="text" name="nomor_dokumen_kegiatan" aria-label="nomor_dokumen_kegiatan" id="nomor_dokumen_kegiatan" {!!
                  (Helper::checkIfRequired($item, 'nomor_dokumen_kegiatan' )) ? ' data-validation="required" required' : '' !!} value="{{ old('nomor_dokumen_kegiatan', !empty($item->Pemasukan->nomor_dokumen_kegiatan) ? $item->Pemasukan->nomor_dokumen_kegiatan : '') }}" />
        ...
        <div class="form-group {{ $errors->has('tanggal_pelaksanaan') ? ' has-error' : '' }}">
          ...
          <div class="form-group {{ $errors->has('jumlah_barang') ? ' has-error' : '' }}">
            <label for="jumlah_barang_opname" class="col-md-3 control-label">Jumlah Barang Terbaru</label>
            <div class="col-md-7 col-sm-12">
              <input class="form-control" type="number" min="1" name="jumlah_barang_opname" aria-label="jumlah_barang_opname"
                id="jumlah_barang_opname" value="{{ old('jumlah_barang_opname', '') }}" {!!
