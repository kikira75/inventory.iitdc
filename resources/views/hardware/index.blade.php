...
@section('header_right')
  @if (Auth::user()->isSuperUser() || Auth::user()->isAdmin())
    ...
    {{--  <a href="{{ route('hardware/CleansingDataApi') }}" style="margin-right: 5px;" class="btn btn-default">Clean Data Api</a>  --}}
    <a href="{{ route('hardware/sendApiFinal') }}" style="margin-right: 5px;" class="btn btn-default">send Api final</a>
    <a href="{{ route('hardware/sendApi') }}" style="margin-right: 5px;" class="btn btn-default">send Api</a>
