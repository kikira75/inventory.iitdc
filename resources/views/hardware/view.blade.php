                            ...
                            <div class="col-md-8">
                                ...
                                <div class="container row-striped">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->asset_tag) ? ucwords($asset->asset_tag) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->name) ? ucwords($asset->name) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->kategori_barang) ? ucwords($asset->kategori_barang) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->owner) ? ucwords($asset->owner) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->departemen) ? ucwords($asset->departemen) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->site) ? ucwords($asset->site) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->lokasi_asset) ? ucwords($asset->lokasi_asset) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->detail_lokasi_asset) ? ucwords($asset->detail_lokasi_asset) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->event) ? ucwords($asset->event) : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                        @php
                                            $lampiranList = array_filter(explode(',', $asset->lampiran ?? ''));
                                        @endphp

                                        @if(count($lampiranList))
                                            <div>
                                                {!! implode(', ', array_map(function($lampiran) {
                                                    return '<a href="' . asset($lampiran) . '" target="_blank">' . basename($lampiran) . '</a>';
                                                }, $lampiranList)) !!}
                                            </div>
                                        @else
                                    ...
                                    <!--<div class="row">-->
                                    <!--    <div class="col-md-2">-->
                                    <!--        <strong>Methode Pengadaan</strong>-->
                                    <!--    </div>-->
                                    <!--    <div class="col-md-6">-->
                                    <!--        {{ !empty($asset->methode_pengadaan) ? ucwords($asset->methode_pengadaan) : '-' }}-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <!--<div class="row">-->
                                    <!--    <div class="col-md-2">-->
                                    <!--        <strong>Nomor Purchase</strong>-->
                                    <!--    </div>-->
                                    <!--    <div class="col-md-6">-->
                                    <!--        {{ !empty($asset->nomor_purchase) ? ucwords($asset->nomor_purchase) : '-' }}-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    {{--  <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->saldo_awal) ? $asset->saldo_awal : '0' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->penyesuaian) ? $asset->penyesuaian : '0' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>Saldo Buku</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->saldo_buku) ? $asset->saldo_buku : '0' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->stock_opname) ? $asset->stock_opname : '0' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            {{ !empty($asset->selisih) ? $asset->selisih : '0' }}
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>{{ ucwords('Pemasukan') }}</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->pemasukan) ? $asset->pemasukan : '0' }}
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>{{ ucwords('pengeluaran') }}</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->pengeluaran) ? $asset->pengeluaran : '0' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>{{ ucwords('jumlah barang') }}</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->jumlah_barang) ? $asset->jumlah_barang : '0' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>{{ ucwords('Satuan Barang') }}</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->satuan_barang) ? $asset->satuan_barang : '0' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>{{ ucwords('Mata Uang') }}</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->mata_uang) ? $asset->mata_uang : '-' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>{{ ucwords('Harga Satuan') }}</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->harga_satuan_barang) ? $asset->harga_satuan_barang : '0' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>{{ ucwords('Total Harga') }}</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->harga_total_barang) ? $asset->harga_total_barang : '0' }}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <strong>{{ ucwords('Status Kirim') }}</strong>
                                        </div>
                                        <div class="col-md-6">
                                            {{ !empty($asset->status_kirim) ? $asset->status_kirim : '-' }}
                                        </div>
                                    </div>
