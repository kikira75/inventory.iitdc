                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        @can('index', \App\Models\Asset::class)
                            <li class="treeview{{ ((Request::is('statuslabels/*') || Request::is('hardware*')) ? ' active' : '') }}">
                                ...
                                <li{!! (Request::is('listall') == 'listall' ? ' class="active"' : '') !!}>
                                        <a href="{{ route('listall.index') }}"><i class="fas fa-circle-arrow-left fa-fw"></i>
                                            List All
                                        </a>
                                </li>
                                <li>
                                        <a href="{{ url('hardware') }}">
                                            ...
                                            <i class="fas fa-folder text-grey fa-fw" aria-hidden="true"></i>
                                            {{ trans('Data Asset') }}
                                        </a>
                                    </li>
                                    ...
                                    <li{!! (Request::is('pemasukan') == 'pemasukan' ? ' class="active"' : '') !!}>
                                        <a href="{{ route('pemasukan.index') }}"><i class="fas fa-circle-arrow-left fa-fw"></i>
                                            {{ trans('Pemasukan') }}
                                        </a>
                                    </li>
                                    <li{!! (Request::is('pengeluaran') == 'pengeluaran' ? ' class="active"' : '') !!}>
                                        <a href="{{ route('pengeluaran.index') }}"><i class="fas fa-circle-arrow-right fa-fw"></i>
                                            {{ trans('Pengeluaran') }}
                                        </a>
                                    </li>
                                    <li{!! (Request::is('stockopname') == 'stockopname' ? ' class="active"' : '') !!}>
                                        <a href="{{ route('stockopname.index') }}"><i class="fas fa-warehouse fa-fw"></i>
                                            {{ trans('Stockopname') }}
                                        </a>
                                    </li>
                                    <li{!! (Request::is('adjusment') == 'adjusment' ? ' class="active"' : '') !!}>
                                        <a href="{{ route('adjusment.index') }}"><i class="fas fa-pen-to-square fa-fw"></i>
                                            {{ trans('Adjusment') }}
                                        </a>
                                    </li>
                                    @can('create', \App\Models\Asset::class)
                        ...
                        <!-- 
                        @can('view', \App\Models\Pemasukan::class)
                            <li{!! (Request::is('pemasukan*') ? ' class="active"' : '') !!}>
                                <a href="{{ route('pemasukan.index') }}" accesskey="6">
                        ...
                        @can('view', \App\Models\Pengeluaran::class)
                            <li{!! (Request::is('pengeluaran*') ? ' class="active"' : '') !!}>
                                <a href="{{ route('pengeluaran.index') }}" accesskey="6">
                        ...
                        @can('view', \App\Models\Stockopname::class)
                            <li{!! (Request::is('stockopname*') ? ' class="active"' : '') !!}>
                                <a href="{{ route('stockopname.index') }}" accesskey="6">
                                    <i class="fa fa-warehouse fa-fw"></i>
                                    <span>Stockopname</span>
                                </a>
                            </li>
                        @endcan

                        @can('view', \App\Models\Adjusment::class)
                            <li{!! (Request::is('adjusment*') ? ' class="active"' : '') !!}>
                                <a href="{{ route('adjusment.index') }}" accesskey="6">
                        ...
                        @if (Auth::user()->isSuperUser() || Auth::user()->isAdmin())
                            ...
                            <li>
                                <a href="{{ route('reports.activity') }}" {{ (Request::is('reports/activity') ? ' class="active"' : '') }}>
                                    <i class="fas fa-history fa-fw" aria-hidden="true"></i>    
