...
<!-- Seats -->
<div class="form-group {{ $errors->has('tipe_dokumen') ? ' has-error' : '' }}">
    <label for="tipe_dokumen" class="col-md-3 control-label">{{ trans('Tipe Dokumen') }}</label>
    <div class="col-md-8 col-sm-12 required">
        <div class="col-md-2" style="padding-left:0px">
            <input class="form-control" type="text" name="tipe_dokumen" id="tipe_dokumen" value="{{ Request::old('tipe_dokumen', $item->tipe_dokumen) }}" />
        </div>
    </div>
    {!! $errors->first('tipe_dokumen', '<div class="col-md-8 col-md-offset-3"><span class="alert-msg" aria-hidden="true"><i class="fas fa-times" aria-hidden="true"></i> :message</span></div>') !!}
</div>
