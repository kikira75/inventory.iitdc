...
use App\Http\Controllers\jenisPengController;
use App\Http\Controllers\keteranganController;
use App\Http\Controllers\StatusPController;
use App\Models\StockOpname;

Route::post('pemasukan/{id}/lampiran/delete/{index}', [PemasukanController::class, 'deleteLampiran'])
    ->name('pemasukan.lampiran.delete');
Route::post('pengeluaran/{id}/lampiran/delete/{index}', [PengeluaranController::class, 'deleteLampiran'])
    ->name('pengeluaran.lampiran.delete');
Route::post('stockopname/{id}/lampiran/delete/{index}', [StockopnameController::class, 'deleteLampiran'])
    ->name('stockopname.lampiran.delete');
Route::post('adjusment/{id}/lampiran/delete/{index}', [AdjusmentController::class, 'deleteLampiran'])
    ->name('adjusment.lampiran.delete');
Route::post('hardware/{id}/lampiran/delete/{index}', [AssetsController::class, 'deleteLampiran'])
    ->name('hardware.lampiran.delete');


Route::get('/pemasukan/{id}/restore', [PemasukanController::class, 'restore'])
     ->name('pemasukan.restore');
Route::post('/pemasukan/bulk-actions', [PemasukanController::class, 'bulkActions'])
     ->name('pemasukan.bulkActions');
Route::get('/pemasukan/{id}/restore', [PemasukanController::class, 'restore'])->name('pemasukan.restore');

Route::get('/pengeluaran/{id}/restore', [PengeluaranController::class, 'restore'])
     ->name('pengeluaran.restore');
Route::post('/pengeluaran/bulk-actions', [PengeluaranController::class, 'bulkActions'])
     ->name('pengeluaran.bulkActions');
Route::get('/pengeluaran/{id}/restore', [PengeluaranController::class, 'restore'])->name('pengeluaran.restore');


Route::get('/stockopname/{id}/restore', [StockopnameController::class, 'restore'])
     ->name('stockopname.restore');
Route::post('/stockopname/bulk-actions', [StockopnameController::class, 'bulkActions'])
     ->name('stockopname.bulkActions');
Route::get('/stockopname/{id}/restore', [StockopnameController::class, 'restore'])->name('stockopname.restore');

Route::get('/adjusment/{id}/restore', [AdjusmentController::class, 'restore'])
     ->name('adjusment.restore');
Route::post('/adjusment/bulk-actions', [AdjusmentController::class, 'bulkActions'])
     ->name('adjusment.bulkActions');
Route::get('/adjusment/{id}/restore', [AdjusmentController::class, 'restore'])->name('adjusment.restore');


    

Route::post('/kode-dokumen/store', [App\Http\Controllers\KodeDokumenController::class, 'store'])->name('kode-dokumen.store');
Route::delete('/kode-dokumen/delete', [App\Http\Controllers\KodeDokumenController::class, 'destroy'])->name('kode-dokumen.destroy');

Route::post('/nama_status/store', [StatusPController::class, 'store'])->name('nama_statusp.store');
Route::delete('/nama_status/delete', [StatusPController::class, 'destroy'])->name('nama_statusp.destroy');
Route::post('/jenis_peng/store', [jenisPengController::class, 'store'])->name('jenis_peng.store');
Route::delete('/jeni_speng/delete', [jenisPengController::class, 'destroy'])->name('jenis_peng.destroy');
Route::post('/lokasi-pemasukan/store', [LokasiController::class, 'store'])->name('lokasi_pem.store');
Route::delete('/lokasi-pemasukan/delete', [LokasiController::class, 'destroy'])->name('lokasi_pem.destroy');
Route::post('/Detaillokasi-pemasukan/store', [DetailLokasiController::class, 'store'])->name('detail_lokasi_pem.store');
Route::delete('/Detaillokasi-pemasukan/delete', [DetailLokasiController::class, 'destroy'])->name('detail_lokasi_pem.destroy');
Route::post('/keterangan/store', [keteranganController::class, 'store'])->name('keterangan.store');
Route::delete('/keterangan/delete', [keteranganController::class, 'destroy'])->name('keterangan.destroy');
Route::post('/ownerr/store', [OwnerController::class, 'store'])->name('ownerr.store');
Route::delete('/ownerr/delete', [OwnerController::class, 'destroy'])->name('ownerr.destroy');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('hardware/download-template', 'AssetsController@downloadTemplate')->name('hardware.downloadTemplate');
    Route::get(
        'reports/activity',
