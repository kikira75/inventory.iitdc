...
use App\Http\Controllers\Api\ListAllController;
...
Route::group(['prefix' => 'v1', 'middleware' => ['api', 'throttle:api']], function () {
    ...
    // listall
    Route::resource('listall', 
    ListAllController::class,
    ['names' => [
            // 'index' => 'api.listall.index',
        ],
    'parameters' => ['listall' => 'id'],
    ]
    ); 
    
    // pemasukan
    Route::resource('pemasukan', 
    PemasukanController::class,
    ['names' => [
            'index' => 'api.pemasukan.index',
            'create' => 'api.pemasukan.create',
            'edit' => 'api.pemasukan.edit',
            'show' => 'api.pemasukan.show',
            'update' => 'api.pemasukan.update',
            'store' => 'api.pemasukan.store',
            'destroy' => 'api.pemasukan.destroy',
        ],
    'parameters' => ['pemasukan' => 'id'],
    ]
    ); 

    Route::resource('pengeluaran', 
    PengeluaranController::class,
    ['names' => [
            'index' => 'api.pengeluaran.index',
            'create' => 'api.pengeluaran.create',
            'edit' => 'api.pengeluaran.edit',
            'show' => 'api.pengeluaran.show',
            'update' => 'api.pengeluaran.update',
            'store' => 'api.pengeluaran.store',
            'destroy' => 'api.pengeluaran.destroy',
        ],
    'parameters' => ['pengeluaran' => 'id'],
    ]
    ); 

    Route::resource('stockopname', 
    StockopnameController::class,
    ['names' => [
            'index' => 'api.stockopname.index',
            'create' => 'api.stockopname.create',
            'edit' => 'api.stockopname.edit',
            'show' => 'api.stockopname.show',
            'update' => 'api.stockopname.update',
            'store' => 'api.stockopname.store',
            'destroy' => 'api.stockopname.destroy',
        ],
    'parameters' => ['stockopname' => 'id'],
    ]
    ); 

    Route::resource('adjusment', 
    AdjusmentController::class,
    ['names' => [
            'index' => 'api.adjusment.index',
            'create' => 'api.adjusment.create',
            'edit' => 'api.adjusment.edit',
            'show' => 'api.adjusment.show',
            'update' => 'api.adjusment.update',
            'store' => 'api.adjusment.store',
            'destroy' => 'api.adjusment.destroy',
        ],
    'parameters' => ['adjusment' => 'id'],
    ]
    ); 
