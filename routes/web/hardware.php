...
Route::group(
    ...
    function () {
        ...
        Route::post('hardware/update', [AssetsController::class, 'update'])->name('hardware/update');
        ...
        Route::get('{assetId}/pemasukan',
            [AssetsController::class, 'getPemasukan']
        )->name('hardware.pemasukan.create');

        Route::post('{assetId}/pemasukan',
            [AssetsController::class, 'savePemasukan']
        )->name('hardware.pemasukan.savePemasukan');

        Route::get('{assetId}/stockOpname',
            [AssetsController::class, 'getStockOpname']
        )->name('hardware.stockOpname.create');

        Route::post('{assetId}/stockOpname',
            [AssetsController::class, 'saveStockOpname']
        )->name('hardware.stockOpname.saveStockOpname');
        
        Route::get('{assetId}/adjusment',
            [AssetsController::class, 'getAdjusment']
        )->name('hardware.adjusment.create');

        Route::post('{assetId}/adjusment',
            [AssetsController::class, 'saveAdjusment']
        )->name('hardware.adjusment.saveAdjusment');

    });


Route::get('/hardware/cekNomorPengiriman/{nomorPengiriman}', [AssetsController::class, "cekNomorPengiriman"])->withoutMiddleware(['auth']);

Route::group(['middleware' => 'auth'], function () {
  
    Route::get('/get-companiess', [AssetsController::class, 'getDataCompanies']);
    // Route::get('/get-kode-barang', [PemasukanController::class, 'getKodeBarang']);
  });
...
Route::get('sendApi', [AssetsController::class, 'sendApi'])->name('hardware/sendApi');
Route::get('sendApiFinal', [AssetsController::class, 'sendApiFinal'])->name('hardware/sendApiFinal');
Route::get('CleansingDataApi', [AssetsController::class, 'CleansingDataApi'])->name('hardware/CleansingDataApi');
