...
//            'namespace' => $this->namespace, //okay, I don't know what this means, but somehow this might be a problem for us?
            ...
            require base_path('routes/web/pemasukan.php');
            require base_path('routes/web/listall.php');
            require base_path('routes/web/pengeluaran.php');
            require base_path('routes/web/stockopname.php');
            require base_path('routes/web/adjusment.php');
