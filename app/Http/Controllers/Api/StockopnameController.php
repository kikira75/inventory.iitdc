...
use App\Http\Transformers\StockopnameTransformer;
...
class StockopnameController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $pemasukan = StockOpname::with('asset');
        // dd($pemasukan);
        ...
        return (new StockopnameTransformer)->transformStockopnames($pemasukan, $total);
