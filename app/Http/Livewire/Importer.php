...
class Importer extends Component
{
    ...
    public function mount()
    {
        ...
        $this->assets_fields = [
            'name' => 'Nama Assets',
            'asset_tag' => 'Asset Tag ID',
            'owner' => 'Asset Owner',
            'departemen' => 'Department',
            'site' => 'Site',
            'lokasi_asset' => 'Lokasi',
            'detail_lokasi_asset' => 'Detail Lokasi',
            'status_pemasukan_mgpa' => 'Status Asset ITDC',
            'event' => 'Event',
            'kategori_barang' => 'Kategori Asset',
            'nomor_kategori_barang' => 'ID Kategori Asset',
            'kode_dokumen_pabean' => 'Kode Pabean',
            'nama_dokumen_pabean' => 'Label Pabean',
            'satuan_barang' => 'Satuan Barang',
            'harga_satuan_barang' => 'Harga Satuan Barang',
            'mata_uang' => 'Mata Uang',
