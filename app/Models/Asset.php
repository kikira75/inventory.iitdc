...
class Asset extends Depreciable
{
    ...
    protected $rules = [
        ...
        'name'             => 'required|nullable|max:255|regex:~^[^<!>?:;\[\]\{\}]+$~',
        ...
        'owner'             => 'nullable|regex:~^[^<!>?:;\[\]\{\}]+$~',
        'departemen'        => 'nullable|regex:~^[^<!>?:;\[\]\{\}]+$~',
        'site'              => 'nullable|regex:~^[^<!>?:;\[\]\{\}]+$~',
        'lokasi'            => 'nullable|regex:~^[^<!>?:;\[\]\{\}]+$~',
        'status_pemasukan_mgpa' => 'required',
        // 'ncompanies'    => 'required',
        'jenis_transaksi'   => 'required',
        'nomor_daftar'   => 'required_if_accepted:jenis_transaksi,"y"|unique:pemasukan,nomor_daftar|regex:~^[^<!>?:;\[\]\{\}]+$~',
        'tanggal_daftar'   => 'required_if_accepted:jenis_transaksi,"y"|date|date_format:Y-m-d',
        'nomor_pemasukan'   => 'required_if_accepted:jenis_transaksi,"y"|unique:pemasukan,nomor_pemasukan|regex:~^[^<!>?:;\[\]\{\}]+$~',
        'tanggal_pemasukan'   => 'required_if_accepted:jenis_transaksi,"y"|date|date_format:Y-m-d',
        'nama_pengirim'   => 'required_if_accepted:jenis_transaksi,y|regex:~^[^<!>?:;\[\]\{\}]+$~',
        'kode_dokumen_pabean'   => 'nullable|string',
        'tanggal_dokumen_pabean'   => 'required_if_accepted:jenis_transaksi,"y"|date|date_format:Y-m-d',
        'nomor_pengajuan'=>'unique:assets,nomor_pengajuan|regex:~^[^<!>?:;\[\]\{\}]+$~',
        // 'tanggal_pengajuan'=>'nullable|date',
        'lokasi_asset'=>'nullable',
        'detail_lokasi_asset'=>'nullable',
        'jumlah_baris_kode'=>'integer',
        'jumlah_baris_pengeluaran'=>'integer',
        'jumlah_baris_adjustment'=>'integer',
        'jumlah_baris_stockopname'=>'integer', 
    ];
    ...
    protected $fillable = [
        ...
        'nama_dokumen_pabean',
        'jumlah_baris_kode',
        'jumlah_baris_pengeluaran',
        'jumlah_baris_adjustment',
        'jumlah_baris_stockopname', 
        'bea',
        'ppn',
        'ppnbm',
        'pph_impor',
    ...
    {
        return $this->hasOne(Pemasukan::class, 'assets_id', 'id');
    }

    public function Pengeluaran()
    {
        return $this->belongsToMany(Pengeluaran::class, 'assets_id', 'id');
    }
