...
class User extends SnipeModel implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract, HasLocalePreference
{
    ...
    public function isLogistik(){
        return $this->checkPermissionSection('a_logistik');
    }

    public function isAdminInputData(){
        return $this->checkPermissionSection('a_inputdata');
    }

    public function isAdminView(){
        return $this->checkPermissionSection('a.view');
    }
