 ...
 */
class StockopnamePresenter extends Presenter
{
    /**
    ...
    public static function dataTableLayout()
    {
        $layout = [
            ...
            [
                ...
                'searchable' => true,
                'sortable' => true,
                'title' => trans('Jumlah Barang (Stockopname)'),
            ], [
                'field' => 'satuan_barang',
                'searchable' => true,
                'sortable' => true,
                ...
                'field' => 'jumlah_barang_sebelumnya',
                'searchable' => true,
                'sortable' => true,
                'title' => trans('Jumlah Barang Sebelumnya'),
            ], [
                'field' => 'selisih_barang',
                'searchable' => true,
                'sortable' => true,
                'title' => trans('Selisih Barang'),
            ], [
        ...
        $layout[] = [
            ...
            'formatter' => 'stockopnameActionsFormatter',
        ];
